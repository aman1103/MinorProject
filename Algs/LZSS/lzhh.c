/*
	...
	Filename:               lzhh.C
	Decompression program:  lzhx.c
	Date:                   August 19-23, 2006

	Description:

		LZ77/LZSS with *hashing* plus adaptive Huffman on the length codes.
	...
	To compile:   tcc -w -mc lzhh (use *COMPACT* or *LARGE* memory model)
	              bcc32 -w lzhh
	              g++ -O2 lzhh.c -s -o  lzhh
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
